...
public class CallRecord {
    ...
    // We use call_id as the Primary Key for this specific queue attempt
    @Id
    @Column(name = "call_id", nullable = false)
    private String callId;

    @Column(name = "crt_object_id")
    ...
    public void setIsOutbound(Boolean isOutbound) { this.isOutbound = isOutbound; }
